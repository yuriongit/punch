...
import { PAGE_SLIDE_DOWN_VARIANTS } from "../../../constants/animations"
...
function RouteComponent() {
  return (
    <AnimatePresence mode="wait">
      <motion.main
        variants={PAGE_SLIDE_DOWN_VARIANTS}
        initial="initial"
        animate="animate"
        exit="exit"
        // style={{ perspective: 1200 }}
        className="tracking-tight flex-col px-10 flex min-w-full items-center min-h-screen text-center justify-between py-10"
      >
        <div />
        <div className="space-y-3 flex flex-col items-center justify-center">
          ...
          <p className="max-w-lg">
            ...
            doesn't mean that the core functionality and more isn' Isn't served
            :)
          </p>
        </div>
        <Link
